function result = FigureB_PCEC(T_sys, P_sys)
% ==========================================================
% Figure B : PCEC system model
% Input:
%   T_sys [K]
%   P_sys [Pa]
% Output (struct):
...
%% ===== 3. Output struct =====
result.eta_PCEC   = eta_PCEC;
result.W_PCEC     = W_PCEC;
result.W_heater   = W_heater;
result.Q_dot_PCEC = Q_dot_PCEC;
