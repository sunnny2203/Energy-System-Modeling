...
fprintf("\n=== EXPANDER CHECK ===\n");
fprintf("T1=%.2f K, P1=%.2f bar\n", T13, P(13)/1e5);
fprintf("T2s=%.2f K, P2=%.2f bar\n", T13_outs, P_out_exp/1e5);
fprintf("T2 =%.2f K (actual)\n", T13_out);
fprintf("Δh_s=%.3e J/kg,  Δh=%.3e J/kg\n", (h13-h13s_out), (h13-h13_out));
fprintf("mDot13=%.3f kg/s,  W_exp=%.3e W\n", mDot(13), W_exp);
...
fprintf("Ammonia LHV power in           : %.3e W\n", Fuel_LHV_in);
